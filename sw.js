...
const urlsToCache = [
    '/Earnteachhub/',
    '/Earnteachhub/index.html',
    '/Earnteachhub/admin.html',
    '/Earnteachhub/logo-192.png',
    '/Earnteachhub/logo-512.png',
    '/Earnteachhub/manifest.json'
];
...
self.addEventListener('push', (event) => {
    let data = {
        ...
        icon: '/Earnteachhub/logo-192.png',
        badge: '/Earnteachhub/logo-192.png'
    };
            ...
            clients.matchAll({ type: 'window', includeUncontrolled: true })
                .then((clientList) => {
                    for (let i = 0; i < clientList.length; i++) {
                        ...
                        if (client.url.includes('/Earnteachhub/') && 'focus' in client) {
                            return client.focus();
                        }
                    }
                    if (clients.openWindow) {
                        return clients.openWindow('/Earnteachhub/');
                    }
                })
        );
    }
